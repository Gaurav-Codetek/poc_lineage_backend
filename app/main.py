...
from app.api import catalog_metadata, column_lineage, dq, health, information_schema, lineage_retriever, stats, table_lineage
...
API_ROUTERS = [
    ...
    (information_schema.router, "/information-schema"),
    (stats.router, "/stats"),
